                    ...
                    <Card className="petPals1">
                        <CardBody>
                            <CardText className="todo-text1">
                                <p>Here at Pet Pals you can Sign up and create your own pet profile. This profile contains basic information of your fur or feathered kid, and in the future we will enable our users to upload their own personal images. Should you need to edit or remove a pet, we do have the option to delete the profile.</p>
                                <p>
